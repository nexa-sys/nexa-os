...
use nzip::{
    compress, compress2, compressBound, deflate, deflateEnd, deflateInit_, deflateReset, inflate,
    inflateEnd, inflateInit_, inflateReset, uncompress, z_stream, ZLIB_VERSION, Z_BEST_COMPRESSION,
    Z_BEST_SPEED, Z_DEFAULT_COMPRESSION, Z_FINISH, Z_NO_FLUSH, Z_OK, Z_STREAM_END,
};
