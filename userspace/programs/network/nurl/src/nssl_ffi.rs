...
use std::os::raw::{c_int, c_long, c_char, c_uchar, c_uint, c_ulong, c_void};
...
extern "C" {
    ...
    pub fn SSL_CTX_use_certificate_file(ctx: *mut SSL_CTX, file: *const c_char, type_: c_int) -> c_int;
    
    /// Load certificate chain file
    pub fn SSL_CTX_use_certificate_chain_file(ctx: *mut SSL_CTX, file: *const c_char) -> c_int;
    
    /// Load private key file
    pub fn SSL_CTX_use_PrivateKey_file(ctx: *mut SSL_CTX, file: *const c_char, type_: c_int) -> c_int;
    
    /// Check private key
    pub fn SSL_CTX_check_private_key(ctx: *const SSL_CTX) -> c_int;
    
    /// Load CA verify locations
    pub fn SSL_CTX_load_verify_locations(ctx: *mut SSL_CTX, ca_file: *const c_char, ca_path: *const c_char) -> c_int;
    
    /// Set default verify paths
    pub fn SSL_CTX_set_default_verify_paths(ctx: *mut SSL_CTX) -> c_int;
    
    /// Set ALPN protocols
    pub fn SSL_CTX_set_alpn_protos(ctx: *mut SSL_CTX, protos: *const c_uchar, protos_len: c_uint) -> c_int;
    ...
    pub fn SSL_read_ex(ssl: *mut SSL, buf: *mut c_uchar, num: usize, readbytes: *mut usize) -> c_int;
    
    /// SSL write with extended error handling
    pub fn SSL_write_ex(ssl: *mut SSL, buf: *const c_uchar, num: usize, written: *mut usize) -> c_int;
