...
impl Sha512 {
    ...
    pub fn finalize(&mut self) -> Vec<u8> {
        ...
        let digest_size = if self.is_384 { SHA384_DIGEST_SIZE } else { SHA512_DIGEST_SIZE };
...
impl RsaPublicKey {
    ...
    pub fn verify_pkcs1_v15_any(&self, message_hash: &[u8], expected_algo: HashAlgorithm, signature: &[u8]) -> bool {
        ...
        if algo != expected_algo {
            crate::kinfo!("RSA: hash algorithm mismatch, expected {:?}, got {:?}", expected_algo, algo);
            return false;
        }
...
pub const OID_SIGNING_CERTIFICATE_V2: &[u8] = &[0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x2f];

/// OID for timestampToken: 1.2.840.113549.1.9.16.2.14
pub const OID_TIMESTAMP_TOKEN: &[u8] = &[0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x09, 0x10, 0x02, 0x0e];
...
impl SignatureAlgorithm {
    ...
    pub fn hash_algorithm(self) -> HashAlgorithm {
        match self {
            SignatureAlgorithm::RsaSha256 | SignatureAlgorithm::EcdsaSha256 => HashAlgorithm::Sha256,
            SignatureAlgorithm::RsaSha384 | SignatureAlgorithm::EcdsaSha384 => HashAlgorithm::Sha384,
            SignatureAlgorithm::RsaSha512 | SignatureAlgorithm::EcdsaSha512 => HashAlgorithm::Sha512,
    ...
    pub fn is_ecdsa(self) -> bool {
        matches!(self, SignatureAlgorithm::EcdsaSha256 | SignatureAlgorithm::EcdsaSha384 | SignatureAlgorithm::EcdsaSha512)
    }
}
