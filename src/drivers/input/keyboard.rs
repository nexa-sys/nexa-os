...
use super::event::{
    InputDeviceInfo, InputEvent, InputId, BUS_I8042, EV_KEY, EV_MSC, EV_SYN, KEY_0, KEY_1, KEY_2,
    KEY_3, KEY_4, KEY_5, KEY_6, KEY_7, KEY_8, KEY_9, KEY_A, KEY_APOSTROPHE, KEY_B, KEY_BACKSLASH,
    KEY_BACKSPACE, KEY_C, KEY_CAPSLOCK, KEY_COMMA, KEY_D, KEY_DELETE, KEY_DOT, KEY_DOWN, KEY_E,
    KEY_END, KEY_ENTER, KEY_EQUAL, KEY_ESC, KEY_F, KEY_F1, KEY_F10, KEY_F11, KEY_F12, KEY_F2,
    KEY_F3, KEY_F4, KEY_F5, KEY_F6, KEY_F7, KEY_F8, KEY_F9, KEY_G, KEY_GRAVE, KEY_H, KEY_HOME,
    KEY_I, KEY_INSERT, KEY_J, KEY_K, KEY_KPASTERISK, KEY_L, KEY_LEFT, KEY_LEFTALT, KEY_LEFTBRACE,
    KEY_LEFTCTRL, KEY_LEFTSHIFT, KEY_M, KEY_MINUS, KEY_N, KEY_NUMLOCK, KEY_O, KEY_P, KEY_PAGEDOWN,
    KEY_PAGEUP, KEY_Q, KEY_R, KEY_RIGHT, KEY_RIGHTBRACE, KEY_RIGHTSHIFT, KEY_S, KEY_SCROLLLOCK,
    KEY_SEMICOLON, KEY_SLASH, KEY_SPACE, KEY_T, KEY_TAB, KEY_U, KEY_UP, KEY_V, KEY_W, KEY_X, KEY_Y,
    KEY_Z, MSC_SCAN, SYN_REPORT,
};
use spin::Mutex;
...
static EXTENDED_MODE: core::sync::atomic::AtomicBool = core::sync::atomic::AtomicBool::new(false);
