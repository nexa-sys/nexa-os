...
#[inline(always)]
pub fn blend_row_alpha(src: *const u8, dst: *mut u8, pixels: usize, bpp: usize, alpha: u8) {
    ...
    unsafe {
        ...
        for octet in 0..octet_count {
            ...
            dst_u64.add(base).write_unaligned(blend_pixel_pair_fast(
                sp0,
                dp0,
                alpha32,
                inv_alpha32,
            ...
            dst_u64.add(base + 1).write_unaligned(blend_pixel_pair_fast(
                sp1,
                dp1,
                alpha32,
                inv_alpha32,
            ...
            dst_u64.add(base + 2).write_unaligned(blend_pixel_pair_fast(
                sp2,
                dp2,
                alpha32,
                inv_alpha32,
            ...
            dst_u64.add(base + 3).write_unaligned(blend_pixel_pair_fast(
                sp3,
                dp3,
                alpha32,
                inv_alpha32,
        ...
        for i in 0..rem_pairs {
            ...
            dst_u64
                .add(idx)
                .write_unaligned(blend_pixel_pair_fast(sp, dp, alpha32, inv_alpha32));
        }
        ...
        if remainder % 2 == 1 {
            ...
            dst_u32
                .add(idx)
                .write_unaligned(blend_pixel_fast(s, d, alpha32, inv_alpha32));
        }
    }
}
...
pub fn blend_pixel_pair_fast(src_pair: u64, dst_pair: u64, alpha: u32, inv_alpha: u32) -> u64 {
    ...
    let rb_sum = src_rb
        .wrapping_mul(alpha64)
        .wrapping_add(dst_rb.wrapping_mul(inv_alpha64));
...
#[inline(always)]
pub fn blend_row_alpha_scalar(src: *const u8, dst: *mut u8, pixels: usize, bpp: usize, alpha: u8) {
...
#[inline(always)]
pub fn blend_row_additive(src: *const u8, dst: *mut u8, pixels: usize, bpp: usize) {
    if bpp != 4 || pixels < BATCH_BLEND_THRESHOLD {
    ...
    unsafe {
        ...
        for i in 0..remainder {
            ...
            dst_u32
                .add(rem_base + i)
                .write_unaligned(additive_blend_pixel(s, d));
        }
    }
}
...
#[inline(always)]
pub fn blend_row_additive_scalar(src: *const u8, dst: *mut u8, pixels: usize, bpp: usize) {
    let bytes_per_pixel = bpp.min(3);
    unsafe {
        for i in 0..pixels {
            let offset = i * bpp;
...
#[inline(always)]
pub fn blend_row_multiply(src: *const u8, dst: *mut u8, pixels: usize, bpp: usize) {
    if bpp != 4 || pixels < BATCH_BLEND_THRESHOLD {
    ...
    unsafe {
        ...
        for batch in 0..batch_count {
            ...
            for p in 0..SIMD_BATCH_SIZE {
                ...
                dst_u32
                    .add(base + p)
                    .write_unaligned(multiply_blend_pixel(s, d));
            }
        }
...
#[inline(always)]
pub fn blend_row_multiply_scalar(src: *const u8, dst: *mut u8, pixels: usize, bpp: usize) {
    let bytes_per_pixel = bpp.min(3);
    unsafe {
        for i in 0..pixels {
            let offset = i * bpp;
